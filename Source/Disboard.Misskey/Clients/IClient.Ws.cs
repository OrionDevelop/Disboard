...
namespace Disboard.Misskey.Clients
{
    ...
    public partial class IClient
    {
        ...
        public async Task<List<Notification>> NotificationsWsAsync(bool? following = null, bool? markAsRead = null, int? limit = null, string sinceId = null, string untilId = null)
        {
            var parameters = new List<KeyValuePair<string, object>>();
